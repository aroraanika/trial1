...
JCAP=382 
   if [ $day -lt 10 ]; then day=0$day ; fi
   	...
   	length=33 ;NPROC_O=72; NPROC_C=1 ;NPROC_A=90 ;FHINI=00; nodes=8
        ...
        expt_dir=/home/DESK/anika/GFS-EL/gfs_pratyush/work_daily_3_months/tmp/${expt_name}
        script=/home/DESK/anika/GFS-EL/gfs_pratyush/work_daily_3_months/ptmp/script_resol_GFS/${expt_name}
        echo $script
	mkdir -p $script
        file_name=gfs_config_${JCAP}_${PDY}${cycle}
        output=/home/DESK/anika/GFS-EL/gfs_pratyush/work_daily_3_months/${expt_name}
