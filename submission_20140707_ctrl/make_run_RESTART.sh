...
set -x
 EXPTRUN=GFS
  ...
  len_1=7000 # No of days for first Segment
  #len_1=16425    # No of days for first Segment
...
#  forcingfile=/home/ERPAS/imdoper/model_output/EXTRACT_IMDERP/CFST${JCAP}/crcbias_sst/${sdate}/sst/bias_crctd_sst_${sdate}_${year}.grb
      ...
      JB_NAME=ctrl.GE${yr}${sdate}.${JCAP} ## added .ctrl to job name ANIKA
...
#      cp ${ic_dir}/gdas.${PDY}/cdas1.t00z.sanl $output/siganl.gfs.${PDY}${cycle}
 ...
 sleep 1
	  ...
	  echo $expt_dir
	  sed "s+tmpdir+$tmppath+" JGFS_FORECAST_LOW1 >temp1
