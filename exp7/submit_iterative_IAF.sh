...
set workdir       = /home/DESK/anika/MOM_SIS/work_IAF_exp7     # where the model is run and model output is produced
...
set inputDataDir = /home/DESK/anika/MOM_SIS/work_IAF_exp7/om3_core1/INPUT
...
# ANIKA AUG 3 2020
#set restartdir    =   /home/DESK/anika/MOM_SIS/work/om3_core1/RESTART
set save          = /home/DESK/anika/MOM_SIS/work_IAF_exp7/om3_core1/output_IAF

set StartYear     = 1958
set RestartYear   = 1957
#set EndYear       = 1962
#set EndYear       = 1958
set EndYear       = 1962
# ANIKA AUG 3 2020
...
# combine netcdf files
  ...
  cd $expdir
if ( ! -d $expdir/history   ) mkdir history
if ( ! -d $expdir/ascii   )   mkdir ascii
#----------------------------------------------------------------------------------------------
...
# rename nc files with the date
  foreach ncfile (`/bin/ls *.nc`)
     mv $ncfile history/$year.$begindate.$ncfile
  end
...
cp  $expdir/RESTART/* $expdir/RESTART_$iyr/
echo "RESTART_folder generated"
cp  $expdir/RESTART_$iyr/* $expdir/INPUT/
echo "restart data of previous year copied to INPUT folder"

#cp $expdir/RESTART/* $expdir/INPUT/
