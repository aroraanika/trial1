...
set npes          = 45              # number of processor
...
set code_dir      = $root/anika/MOM5.1.0/src                         # source code directory
set workdir       = /home/DESK/anika/MOM5.1.0/work     # where the model is run and model output is produced
                                   # This is recommended to be a link to the $WORKDIR of the platform.
set expdir        = $workdir/$name
#set inputDataDir  = /home/DESK/anika/MOM5.1.0/INPUT   # This is path to the directory that contains the input data for this experiment.
set inputDataDir  = /home/DESK/anika/MOM5.1.0/work/box1/INPUT   # ANIKA RESTART files are copied to this folder in addition to INPUT files required data.
...
set executable    = $root/anika/MOM5.1.0/exec/$platform/$type/fms_$type.x      # executable created after compilation
...
#
source $root/anika/MOM5.1.0/bin/environs.$platform  # environment variables and loadable modules

set mppnccombine  = $root/anika/MOM5.1.0/bin/mppnccombine.$platform  # path to executable mppnccombine
set time_stamp    = $root/anika/MOM5.1.0/bin/time_stamp.csh          # path to cshell to generate the date
...
#Preprocessings
  $root/anika/MOM5.1.0/exp/preprocessing.csh
